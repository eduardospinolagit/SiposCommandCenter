      ...
      <div class="login-form">
        <div class="form-group">
          ...
          <input v-model="email" class="form-input" type="email"
            placeholder="seu@email.com" autocomplete="email" @keydown.enter="doLogin" />
        </div>
        ...
        <div class="form-group">
          ...
          <div class="input-wrapper">
            <input v-model="password" class="form-input"
              ...
              placeholder="••••••••" autocomplete="current-password" @keydown.enter="doLogin" />
...
.theme-btn:hover { background: var(--accent-subtle); color: var(--accent); border-color: var(--accent); }
...
.login-error {
  ...
  font-size: .8125rem; color: var(--status-danger);
...
.login-footer {
  ...
  text-align: center; margin-top: 1.5rem; opacity: .6;
}
